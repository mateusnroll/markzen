...
|----|------|-------|------|------|----------|------------|
| 1 | Alice Chen | alice@example.com | Senior Engineer | Platform | San Francisco | 2021-03-15 |
| 2 | Bob Smith | bob@example.com | Designer | Product | New York | 2022-01-10 |
| 3 | Carol Jones | carol@example.com | Engineering Manager | Platform | London | 2020-07-22 |
...
Tables are a planned feature. These fixtures will validate rendering once the TipTap `Table` extension is added.
