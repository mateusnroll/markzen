...
3. Run the Draft simplicity review with a fresh independent agent and resolve its findings. Present the Draft for approval. Someone other than the writer must approve it; record the writer identity, approver identity, and exact approved spec digest. The approver may be a human or an independent Review Agent, which evaluates completeness and fidelity without inventing unresolved product decisions.
