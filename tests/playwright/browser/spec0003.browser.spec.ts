...
test('AC7-AC9 AC14-AC16 AC23 revised AC30 AC31-AC32: every visible regular-file row is enabled', async ({ page }) => {
  ...
  await expect(treeRow(page, 'image.png')).not.toHaveAttribute('aria-disabled', 'true')
